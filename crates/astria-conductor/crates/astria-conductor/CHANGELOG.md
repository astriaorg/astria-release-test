...
## [2.0.0](https://github.com/astriaorg/astria-release-test/compare/conductor-vv1.1.0...conductor-vv2.0.0) (2025-04-01)
...
* **proto:** fully split sequencerapis and remove ([#958](https://github.com/astriaorg/astria-release-test/issues/958))
* **proto:** update `SequencerBlockHeader` and related proto types to not use cometbft header ([#830](https://github.com/astriaorg/astria-release-test/issues/830))
* **conductor:** use HTTP to periodically poll Celestia heights  ([#852](https://github.com/astriaorg/astria-release-test/issues/852))
...
* **conductor:** add blackbox tests for conductor running in soft-only mode ([#917](https://github.com/astriaorg/astria-release-test/issues/917)) ([cd38d1d](https://github.com/astriaorg/astria-release-test/commit/cd38d1d5458fd561696590417b647f1844d328f2))
...
* **conductor:** robust Celestia blob fetch, verify, convert ([#946](https://github.com/astriaorg/astria-release-test/issues/946)) ([4357edd](https://github.com/astriaorg/astria-release-test/commit/4357edd4f147171be8dc1cd97d5b4942cd39992d))
...
* **proto:** fully split sequencerapis and remove ([#958](https://github.com/astriaorg/astria-release-test/issues/958)) ([f124c1f](https://github.com/astriaorg/astria-release-test/commit/f124c1f02606bb1a5623b73d067fbf9b596755ac))
* **proto:** update execution service to use sequencerblock ([#954](https://github.com/astriaorg/astria-release-test/issues/954)) ([1a0e54f](https://github.com/astriaorg/astria-release-test/commit/1a0e54fa10d1d0a62cace573d7a54b55852c8561))
...
* **conductor:** use HTTP to periodically poll Celestia heights  ([#852](https://github.com/astriaorg/astria-release-test/issues/852)) ([0124b57](https://github.com/astriaorg/astria-release-test/commit/0124b5723d980dabb9e9928eca3c6436f785122b))
...
* **proto:** update `SequencerBlockHeader` and related proto types to not use cometbft header ([#830](https://github.com/astriaorg/astria-release-test/issues/830)) ([6665948](https://github.com/astriaorg/astria-release-test/commit/6665948892b39a583e0cc623d1355954328bebff))
